...
3. 修改油猴设置
   - ![设置为高级]([images/preview.png](https://github.com/Yantesoft/LinuxdoAssistant/blob/main/step1.png))
   - ![修改SCP限制]([images/preview.png](https://github.com/Yantesoft/LinuxdoAssistant/blob/main/step1.png))
3. **验证安装**
