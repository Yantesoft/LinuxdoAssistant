...
3. 修改油猴设置
4. 
5. - ![设置为高级](https://github.com/Yantesoft/LinuxdoAssistant/blob/main/step1.png?raw=true)
   - ![]([))
   - ![设置为高级](https://github.com/Yantesoft/LinuxdoAssistant/blob/main/step2.png?raw=true)
3. **验证安装**
